...
public class AppntmntsFragment extends Fragment {

    private ArrayList<Appntmnt> list;

    public static Fragment newInstance(ArrayList<Appntmnt> list) {
        AppntmntsFragment fragment = new AppntmntsFragment();
